...
df_both <-
  ...
  mutate (
    ...
    class = factor(
      class,
      levels = c("Pass. Pursuit", "PIE", "DFM", "Scope", "IS", "DesNat", "Ren. Energy", "EEC", "Mech Proto", "QEA", "Research", "P&M", "SustDes", "RoboSys", "DBF", "Personal Proj.", "Test Piece", "Proj. Team/Club")
    ),
...
df_both %>% 
  ...
  labs(color = "Academic Year")
#ggsave("figures/dailyPrintsByAcademicYear.jpg", dpi = 500, bg = "white")
```
